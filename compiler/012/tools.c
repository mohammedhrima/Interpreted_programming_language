        ...
        if (fmt[i] == '%')
        {
            ...
            if (fmt[i] == 'v')
            {
                ...
                if (variable)
                {
                    ...
                    else if (variable->type == integer_ || variable->type == float_)
                        ft_putfloat(fd, variable->value.number, 6);
                    else if (variable->type == boolean_)
                    {
                    ...
                    {
                        ft_putstr(err, "ft_printf didn't know varibale type\n");
                    }
                    ft_putstr(fd, "'");
